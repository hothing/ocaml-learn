...
### Подготовка
Граф городов  и дорог  задан матрицей  смежности. Поскольку  ничего не
сказано, что  дороги могут  быть односторонними, предположим,  что все
дороги двухсторонние,  а значит город i  соединен с городом j  одной и
только одной дорогой и значит матрица симметрична по главной диагонали.

В результате, можно просматривать матрицу по-строчно, и пропускать 
(i-1) первых элементов в строке.

Задача сводится к подсчету суммы значений элементов строк.
